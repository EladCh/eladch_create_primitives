...
class EladchCreateACubeExtension(omni.ext.IExt):
    # ext_id is current extension id. It can be used with extension manager to query additional information, like where
    # this extension is located on filesystem.
    def on_startup(self, ext_id):
        print("[eladch.create_primitives] eladch create a cube startup")
        ...
        with self._window.frame:
            with ui.VStack():
                ...
                def on_click(prim_type):
                    r =omni.kit.commands.execute('CreateMeshPrimWithDefaultXform',
                        prim_type=prim_type)
                    print("clicked!")
    ...
    def on_shutdown(self):
        print("[eladch.create_primitives]  eladch create a cube shutdown")
